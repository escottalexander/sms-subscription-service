        ...
        if (message.split(" ").length > 1) {
          ...
          if (strCmd[0] === "SEND" && campaignCodes.includes(strCmd[1])) {
            ...
            if (strCmd[1] === "ADMIN" && strCmd[2]) {
              ...
              return response;
            } else if (strCmd[1] === "CODE" && strCmd[2] && strCmd[2] !== "STOP") {
            ...
            strCmd[0] === "CHANGE" &&
            strCmd[1] === "CODE" && strCmd[2] && strCmd[3] &&
            strCmd[3] !== "STOP"
          ) {
            // Disallow STOP as a campaignCode
          ...
          } else if (strCmd[0] === "CUSTOM" && (campaignCodes.includes(strCmd[1]) || strCmd[1] === 'ALL') && strCmd[2]) {
          ...
          } else if (strCmd[0] === "SET" && strCmd[1] === "MESSAGE" && strCmd[2]) {
